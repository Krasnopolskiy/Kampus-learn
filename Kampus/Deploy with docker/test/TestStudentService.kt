...
class TestStudentService : AbstractTest {
    override val studentUrl = "$BASE_URL:${container.getMappedPort(8000)}"
    ...
    companion object {
        @JvmStatic
        @Container
        private val container = GenericContainer("kampus-student-service:1.0.0")
            .also { it.setPortBindings(listOf("8000:8000")) }
